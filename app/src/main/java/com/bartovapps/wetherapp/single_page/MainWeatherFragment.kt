package com.bartovapps.wetherapp.single_page
 ...
 * [MainWeatherFragment.OnFragmentInteractionListener] interface
...
class MainWeatherFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): MainWeatherFragment {
            val fragment = MainWeatherFragment()
            val args = Bundle()
